package io.libraryflow.loans.exception;
...
import io.libraryflow.loans.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja las excepciones de tipo IllegalStateException que se lanzan cuando se
     * intenta realizar una operación que no es válida en el estado actual de la
     * aplicación. Crea una respuesta de error estructurada utilizando la clase
     * ApiErrorResponse, que incluye información sobre el error, como el timestamp,
     * el status, el error, el mensaje y el path de la solicitud. Devuelve una
     * respuesta HTTP con el estado 409 (CONFLICT) y el cuerpo de la respuesta de
     * error. Además, registra el error en los logs para facilitar la depuración.
     * 
     * @param ex      IllegalStateException - La excepción que se ha lanzado cuando
     *                se intenta realizar una operación que no es válida en el
     *                estado actual de la aplicación
     * @param request HttpServletRequest - El objeto de solicitud HTTP que contiene
     *                información sobre la solicitud que causó la excepción
     * @return ResponseEntity<ApiErrorResponse> - La respuesta HTTP que contiene el
     *         estado 409 y el cuerpo de la respuesta de error estructurada para
