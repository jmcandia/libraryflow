 ...
 * datos. Contiene campos para el ID del usuario, nombre completo, correo
 * electrónico, número de teléfono y la fecha de creación. La anotación @Entity
 ...
 * el valor del ID se generará automáticamente. El método onCreate() se ejecuta
